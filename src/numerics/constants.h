...
const double K_CONST_ELEMENTARY_CHARGE =
    1.60217646e-19;                  // Elementary charge in Coulombs
const double K_CONST_R = 8.3144598;  // universal gas constant [J·mole−1·K−1]
const double K_CONST_SVV_FHO =
    0.04;  // FHO model steric factor for VV-exchanges
...
const int K_CONST_SUBDIVISIONS = 5;  // amount of subdivisions for numerical
                                     // integration over semi-infinite intervals
const int K_CONST_OMEGA_D_STEP_SIZE =
    10;  // temperature step size for evaluating derivatives when calculating
         // omega integrals of higher orders
/// @}
/// @}
