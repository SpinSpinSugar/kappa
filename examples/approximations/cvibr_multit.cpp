/*
   ...
   \brief compute specific vibrational heat at constant volume in the
   multi-temperature approximation.
*/
...
int main() {
  ...
  cout << "Calculation of the vibrational heat capacity at T1 = " << T1
       << " and different values of T [100, 3000]" << endl;
  ...
  T1 = 1000;
  cout << "Calculation of the vibrational heat capacity at T1 =" << T1
       << " and different values of T [1000, 20000], anharmonic spectrum."
       << endl;
  ...
  T1 = 1000;
  cout << "Calculation of the vibrational heat capacity at T1 =" << T1
       << " and different values of T [1000, 20000], harmonic spectrum."
       << endl;
  ...
  T = 5000;
  T1 = 1000;
  cout << "Calculation of the vibrational heat capacity at T =" << T
       << " and different values of T1 [1000, 20000], anharmonic spectrum."
       << endl;
  cout << "- c_vibr_T(Anharmonic, N2)  " << endl;
  while (T1 <= 20000) {
    std::cout << -approx.c_vibr_T(T, T1, Molecule1_AnH) << endl;
  ...
  T1 = 1000;
  cout << "Calculation of the vibrational heat capacity at T =" << T
       << " and different values of T1 [1000, 20000], harmonic spectrum."
       << endl;
  cout << " c_vibr_T(Harmonic, N2)  " << endl;
  while (T1 <= 20000) {
    std::cout << approx.c_vibr_T(T, T1, Molecule1_H) << endl;
  ...
  while (T1 <= 20000) {
    std::cout << "T1=" << T1
              << " c_vibr_T=" << approx.c_vibr_T(T, T1, Molecule2_H) << endl;
    T1 += 500;
  }
  std::cout << endl;
  std::cout << "***************************************************************"
  ...
  T1 = 1000;
  cout << "Calculation of the vibrational heat capacity at T =" << T
       << " and different values of T1 [0, 20000], anharmonic spectrum."
       << endl;
  cout << " c_vibr_T1(Anharmonic, O2)  " << endl;
  while (T1 <= 20000) {
    std::cout << approx.c_vibr_T1(T, T1, Molecule2_AnH) << endl;
  ...
  T1 = 1000;
  cout << "Calculation of the vibrational heat capacity at T =" << T
       << " and different values of T1 [0, 20000], harmonic spectrum." << endl;
  cout << " c_vibr_T1(Harmonic, O2)  " << endl;
  while (T1 <= 20000) {
    std::cout << approx.c_vibr_T1(T, T1, Molecule2_H) << endl;
    T1 += 500;
