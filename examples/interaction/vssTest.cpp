...
int main(int argc, char **argv) {
  ...
  std::cout << "ESA: "
            << ApproximationTest.omega_integral(2000., N2N2, 1, 1,
                                                models_omega::model_omega_esa)
            << " "
            << ApproximationTest.omega_integral(10000., N2N2, 1, 1,
                                                models_omega::model_omega_esa)
            << std::endl;
  std::cout << "RS: "
            << ApproximationTest.omega_integral(2000., N2N2, 1, 1,
  ...
  std::cout << "ESA: "
            << ApproximationTest.omega_integral(2000., N2N2, 2, 3,
                                                models_omega::model_omega_esa)
            << " "
            << ApproximationTest.omega_integral(10000., N2N2, 2, 3,
                                                models_omega::model_omega_esa)
            << std::endl;
  std::cout << "RS: "
            << ApproximationTest.omega_integral(2000., N2N2, 2, 3,
  ...
  std::cout << "ESA: "
            << ApproximationTest.omega_integral(2000., N2N, 1, 1,
                                                models_omega::model_omega_esa)
            << " "
            << ApproximationTest.omega_integral(10000., N2N, 1, 1,
                                                models_omega::model_omega_esa)
            << std::endl;
  std::cout << "RS: "
            << ApproximationTest.omega_integral(2000., N2N, 1, 1,
  ...
  std::cout << "ESA: "
            << ApproximationTest.omega_integral(2000., N2N, 2, 3,
                                                models_omega::model_omega_esa)
            << " "
            << ApproximationTest.omega_integral(10000., N2N, 2, 3,
                                                models_omega::model_omega_esa)
            << std::endl;
  std::cout << "RS: "
            << ApproximationTest.omega_integral(2000., N2N, 2, 3,
  ...
  // try {
  //   std::cout << ApproximationTest.omega_integral(2000., HH, 2, 3,
  //   models_omega::model_omega_vss);
