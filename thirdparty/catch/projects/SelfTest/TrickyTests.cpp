...
///////////////////////////////////////////////////////////////////////////////
TEST_CASE("Parsing a std::pair", "[Tricky][std::pair]") {
...
///////////////////////////////////////////////////////////////////////////////
TEST_CASE("Where there is more to the expression after the RHS",
          "[Tricky][failing][.]") {
  //    int a = 1, b = 2;
  //    REQUIRE( a == 2 || b == 2 );
  WARN(
...
///////////////////////////////////////////////////////////////////////////////
TEST_CASE("Where the LHS is not a simple value", "[Tricky][failing][.]") {
  /*
  int a = 1;
  int b = 2;

  // This only captures part of the expression, but issues a warning about the
  rest REQUIRE( a+1 == b-1 );
  */
  WARN(
      "Uncomment the code in this test to check that it gives a sensible "
      "compiler error");
...
///////////////////////////////////////////////////////////////////////////////
TEST_CASE("string literals of different sizes can be compared",
          "[Tricky][failing][.]") {
...
struct Test {
  ...
  bool operator==(const Test &rhs) { return (m_value == rhs.m_value); }
  bool operator==(const Test &rhs) const { return (m_value != rhs.m_value); }
...
TEST_CASE("Assertions then sections", "[Tricky]") {
  ...
  SECTION("A section", "") {
    ...
    SECTION("Another other section", "") { REQUIRE(Catch::alwaysTrue()); }
  }
}
...
TEST_CASE("Comparing member function pointers",
          "[Tricky][member function pointer]") {
  typedef void (S::*MF)();
  MF m = &S::f;
...
TEST_CASE("has printf", "") {
  // This can cause problems as, currently, stdout itself is not redirect - only
  // the cout (and cerr) buffer
  printf("spanner");
}
